...
<table>
<tr>
<th width="50%">Game Development</th>
<th width="50%">Backend</th>
</tr>
<tr>
<td valign="top">

Unity and C# for PC, mobile and VR. Gameplay and simulation systems,
editor tooling for designers, and optimisation against a real frame
budget — profiling, memory, draw calls.
...
Go services in production for business systems and high-load traffic.
HTTP and gRPC APIs, PostgreSQL and Redis, message queues, and the
observability to know what the system is actually doing.
